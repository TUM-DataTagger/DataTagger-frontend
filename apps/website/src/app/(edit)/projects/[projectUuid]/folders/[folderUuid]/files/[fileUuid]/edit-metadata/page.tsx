...
import { ProjectFolderFileEditMetadataFooter } from './ProjectFolderFileEditMetadataFooter';
import { ProjectFolderFileEditMetadataForm } from './ProjectFolderFileEditMetadataForm';

export const metadata: Metadata = {
	title: 'Edit project folder file',
};
	...
	return (
		<>
			<div className="bg-base-neutral-800 text-base-xl text-base-neutral-40 dark:bg-base-neutral-100 dark:text-base-neutral-900 sticky top-0 z-10 flex h-16 place-content-between place-items-center px-4 pt-6 pb-4 md:px-[132px]">
				...
				<CloseButton fileUuid={fileUuid} folderUuid={folderUuid} projectUuid={projectUuid} />
			</div>
			<div className="mx-auto flex w-full max-w-[536px] grow flex-col gap-4 px-4 py-12 md:px-0">
				<ProjectFolderFileEditMetadataForm
					data={datasetData}
					fileMetadata={datasetVersionData}
					fileUuid={fileUuid}
					folderUuid={folderUuid}
					projectUuid={projectUuid}
				/>
			</div>
			<ProjectFolderFileEditMetadataFooter fileUuid={fileUuid} folderUuid={folderUuid} projectUuid={projectUuid} />
		</>
	);
}
