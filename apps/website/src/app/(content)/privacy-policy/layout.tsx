import { ArrowLeftIcon, ShieldEllipsisIcon } from 'lucide-react';
			...
			{currentUserData ? null : (
				<>
					...
					<div className="bg-base-neutral-800 dark:bg-base-neutral-100 flex h-16 place-items-center justify-between px-4 md:px-[132px]">
						...
						<span className='dark:text-base-neutral-600" text-base-neutral-300 place-items-end'>Privacy policy</span>
					</div>
				...
				<div className="bg-base-neutral-800 dark:bg-base-neutral-100 h-[194px] px-4">
					<div className="mx-auto flex h-full max-w-(--breakpoint-md) place-items-center gap-[10px]">
						<ShieldEllipsisIcon
							...
							strokeWidth={1.5}
						/>
						<h1 className="text-base-heading-xl text-base-neutral-40 dark:text-base-neutral-900">Privacy policy</h1>
					</div>
				</div>
