			...
			{currentUserData ? null : (
				<>
					...
					<div className="bg-base-neutral-800 dark:bg-base-neutral-100 flex h-16 place-items-center justify-between px-4 md:px-[132px]">
						...
						<span className="text-base-neutral-300 dark:text-base-neutral-600 hidden place-items-end sm:inline">
							Frequently asked questions (FAQ)
						</span>
						<span className="text-base-neutral-300 dark:text-base-neutral-600 place-items-end sm:hidden">FAQ</span>
					</div>
				...
				<div className="bg-base-neutral-800 dark:bg-base-neutral-100 h-[194px] px-4">
					<div className="mx-auto flex h-full max-w-(--breakpoint-md) place-items-center gap-[10px]">
						<MessageCircleQuestionIcon
							...
							strokeWidth={1.5}
						/>
						<h1 className="text-base-heading-xl text-base-neutral-40 dark:text-base-neutral-900 lg:hidden">FAQ</h1>
						<h1 className="text-base-heading-xl text-base-neutral-40 dark:text-base-neutral-900 hidden lg:block">
							Frequently asked questions (FAQ)
						</h1>
					</div>
				</div>
				<div className="prose prose-sm prose-neutral dark:prose-invert prose-h1:text-base-xl prose-h2:text-base-xl prose-h3:text-base-heading-xs prose-h4:text-base-heading-xs md:prose-h1:text-base-heading-xs md:prose-h2:text-base-heading-xs md:prose-h3:text-base-heading-xs md:prose-h4:text-base-heading-xs mx-auto max-w-sm px-4 py-9 break-words md:max-w-(--breakpoint-md)">
					{children}
				</div>
			</div>
		</>
