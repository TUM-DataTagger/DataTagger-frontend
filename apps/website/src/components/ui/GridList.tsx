	...
	return (
		<RACGridList
			...
			className={composeTailwindRenderProps(
				props.className,
				'*:data-drop-target:border-accent layout-grid:flex layout-grid:flex-wrap relative max-h-none overflow-auto overscroll-contain [scrollbar-width:thin] *:data-drop-target:border',
			)}
		>
			{props.children}
		</RACGridList>
			...
			{(values) => (
				<>
					{values.allowsDragging && (
						<Button className="cursor-grab data-dragging:cursor-grabbing" size="icon-xs" slot="drag" variant="unset">
